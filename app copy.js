...
var profileLinks = ['https://www.linkedin.com/in/divyanshu-sahu-820467245/', 'https://www.linkedin.com/in/rangey-raghav-0456711b3/', 'https://www.linkedin.com/in/aniket-kundu/'];
...
async function linkined() {
    ...
    await new Promise(resolve => setTimeout(resolve, 1109));
    ...
    //PLACE ENTER TO SERACH USERID-NAME IN THE INPUT BAR
    await page.keyboard.press('Enter');




    await new Promise(resolve => setTimeout(resolve, 2081));
    ...
    await new Promise(resolve => setTimeout(resolve, 1330));
    ...
    for (let i = 0; i < profileLinks.length; i++) {
        ...
        // await newTab.goto('https://www.linkedin.com/in/archy-gupta-myprofile/');
        ...
        //page down
        await new Promise(resolve => setTimeout(resolve, 2090));


        //button to click collapse button
        ...
        //click button 'CONNECT'of collapse list
        ...
        //type the text in the 'INPUT TEXT FILED'
        ...
        //CLICK SEND BUTTON 'CONNECT' FINAL STEP
        ...
        await new Promise(resolve => setTimeout(resolve, 90099));
